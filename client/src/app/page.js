    ...
    return (
        <>
            <main className='w-full min-h-screen bg-[#101010] montserrat'>
                ...
                <div className="w-full h-screen flex gap-6 pb-10 px-10 pt-24 mobile:flex-col mobile:px-4 mobile:pt-20 mobile:h-auto mobile:gap-8">
                    ...
                    <div className='w-[60%] h-full overflow-y-auto mobile:w-full mobile:h-[100vh]'>
                        <section className='w-full min-h-full bg-[#282828] rounded-lg p-6 flex flex-col mobile:h-[100vh]'>

const ProblemDescriptions = {
    factorial: {
      ...
      inputType: 'number', // Helps CodePanel know what input to render
      defaultInput: 5,
    },
    fibonacci: {
      ...
      mathematicalFormula: `F(n) = F(n-1) + F(n-2) \\text{ for } n > 1, \\text{ with } F(0) = 0 \\text{ and } F(1) = 1.`,
      ...
      constraints: [
        `0 <= n <= 10` // Limiting for visualization clarity
      ],
      inputType: 'number',
      defaultInput: 7,
    },
  ...
  Move disk 1 from B to C`,
      ...
      constraints: [
        `1 <= n <= 5` // Limiting for visualization complexity
      ],
      inputType: 'number',
      defaultInput: 3,
    },
